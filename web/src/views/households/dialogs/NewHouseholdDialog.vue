...
const handleSubmit = async () => {
	...
	try {
		await axiosInstance.post('family/', formData.value)
		emit('success')
		dialogVisible.value = false
		resetForm()
	} catch (err: any) {
		submitError.value = err.response?.data?.message || 'Failed to create household. Please try again.'
	...
	<div
		...
		<div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
			...
			<div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
				<h3 class="text-xl font-bold text-gray-800">Add New Household</h3>
				<button
						@click="handleClose"
